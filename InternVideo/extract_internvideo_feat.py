...
def main(args):
    ...
    model, transform = clip.load(args.internvideo_backbone, device=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--internvideo_backbone', required=True,
                        help='InternVideo backbone')
